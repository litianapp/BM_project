...
#find outlier in Y
stu_res = rstandard(selected_transformed)
...
cv_df %>% 
  ...
  filter(model %in% c("train_transformed", "train_untransformed", "train_lasso"))%>%
  ggplot(aes(x = model, y = rmse)) + geom_violin()+
  labs(title = "Comparison of MSE using Training Data")
